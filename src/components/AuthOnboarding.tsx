...
import { Sparkles, PlusCircle, Key, X } from 'lucide-react';
...
export const AuthOnboarding: React.FC = () => {
  ...
  const handleEnterWithCode = () => {
    ...
    /* =========================================================================
     * TODO: [SUPABASE INTEGRATION - AUTH / JOIN FAMILY WITH CODE]
      ...
      <div className="w-full max-w-md mx-auto my-auto flex flex-col items-center text-center space-y-6">
        ...
        <section className="w-full space-y-3 pt-2">
          <button
            onClick={() => {
              /* =========================================================================
               * TODO: [SUPABASE INTEGRATION - CREATE NEW FAMILY & OWNER PROFILE]
               * const { data: newFam, error } = await supabase
               *   .from('families')
               *   .insert([{ name: 'Família Silva', invite_code: 'SILVA-2024' }])
               *   .select()
               *   .single();
               * ========================================================================= */
          ...
          <button
            onClick={() => {
              /* =========================================================================
               * TODO: [SUPABASE INTEGRATION - EMAIL/PASSWORD AUTH SIGN IN]
               * const { data, error } = await supabase.auth.signInWithPassword({
               *   email: 'parent@familyquest.com',
