...
create policy "profiles deletable by self" on public.profiles
...
begin
  ...
  insert into public.rewards (id, family_id, title, description, points_cost, category, image_url, is_available, created_at)
  values
    ('rew-01', family_id, 'Sorvete no Final de Semana', 'Escolha seu sabor favorito na sorveteria do bairro.', 300, 'food', 'https://lh3.googleusercontent.com/aida-public/AB6AXuAaZIHFQS37oiPujwTQMUSHspf_yIsrpKYyPFlWMR__9xJtI4mmH85_WNDpvDU51LQ0DZ-idh0RQzmMwPisBspDe0pjXHR1nMPneDLGIuNSLAkIdymtlWunp3cpNGZ1bEz-sinX-OZkqS5PpxFIjq1KBb0NssIk-HcjH7nekUsh4ico8nbzkObyXxHMPuNRLv6JEApSeVPr_46g1F5uHYyIVgqDzbbeQy_vy9vW3cAYFZQJBfn1A805', true, now()),
    ('rew-02', family_id, '30 min de Game', 'Tempo extra para jogar videogame hoje.', 500, 'entertainment', 'https://lh3.googleusercontent.com/aida-public/AB6AXuBMCl48S4QAHGs8QdBNO2GFxi0ZeVz-MQotIKjNC5tHtoORmFWpNu_aObN5MpXr2UAa7q5iTZiWbmecAqPEx6Gkegc032pjfJ7iARSrywQtj_QQacUFq3IFgPJPrZtMiFtI9s_lmx8-G2azo0ymz7iImqYu6jp8koE63b1LqFd8nhPCtWyQl3suwFfHEuttEFr1eX6vvtfdnCt03QYF6uUb9QmTW2rpvIXdfpdO1EcuUYsUegqEg1h7', true, now());
end;
$$;
